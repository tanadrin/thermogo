...
def get_neighbors(gamemap, x, y):
    ...
    again whenever possible than to call this function repeatedly.
    '''
...
def hav_distance(la1, lo1, la2, lo2, r = 1):
    '''
    For two coordinates on the surface of a sphere, returns the great circle distance between the two. Assumes a radius of 1; for a different radius, multiply the result by the actual radius of the sphere.
    '''
